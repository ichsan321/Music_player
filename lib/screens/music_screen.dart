...
import 'package:test_app/widgets/music_card.dart';
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Consumer<MusicController>(builder:
                            (BuildContext context, MusicController controller,
                                Widget? child) {
                  ...
                  Expanded(
                    child: Consumer<MusicController>(
                      builder: (BuildContext context,
                          MusicController controller, Widget? child) {
                            ...
                            return MusicCard(
                              trackName:
                                  controller.musicList[index].trackName ??
                                      'No track name',
                              imageUrl:
                                  controller.musicList[index].artworkUrl100 ??
                                      '',
                              artistName:
                                  controller.musicList[index].artistName ?? '',
                              collectionName:
                                  controller.musicList[index].collectionName ??
                                      '',
                              icon: controller.indexMusic == index
                                  ? Icons.pause
                                  : Icons.play_circle_outline,
                              onTap: () async {
                                if (!controller.playMusic ||
                                    controller.indexMusic != index) {
                                  controller.updateMusicPlayAndIndex(
                                      index, true);
                                  controller.updateMusicPause(false);
                                  await controller.audioPlayer.play(
                                      controller.musicList[index].previewUrl ??
                                          '');
                                } else {
                                  controller.updateMusicPlayAndIndex(-1, false);
            ...
            Column(
              children: [
                ...
                Consumer<MusicController>(
                  builder: (BuildContext context, MusicController controller,
                      Widget? child) {
                    String trackName = '';

                    if (controller.indexMusic >= 0) {
                      trackName = controller
                              .musicList[controller.indexMusic].trackName ??
                          '';
                    }
                      ...
                      return Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            CircleAvatar(
                              child: Center(
                                child: Consumer<MusicController>(builder:
